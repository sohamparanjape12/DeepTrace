...
const recentViolations: Violation[] = [
  { violation_id: 'v1', asset_id: 'a1', detected_at: '2026-04-18T08:00:00Z', match_url: 'https://reddit.com/r/soccer/post/a1b2c3', match_type: 'full_match',    gemini_class: 'UNAUTHORIZED',       severity: 'CRITICAL', status: 'open', gemini_reasoning: 'Commercial usage without license on a monetized platform.' },
  { violation_id: 'v2', asset_id: 'a2', detected_at: '2026-04-18T07:30:00Z', match_url: 'https://espn.com/news/article-2',         match_type: 'partial_match', gemini_class: 'EDITORIAL_FAIR_USE', severity: 'LOW',      status: 'open', gemini_reasoning: 'News reporting context; editorial fair use likely applies.' },
  { violation_id: 'v3', asset_id: 'a1', detected_at: '2026-04-17T22:00:00Z', match_url: 'https://sportsblog.net/match-highlights', match_type: 'full_match',    gemini_class: 'UNAUTHORIZED',       severity: 'HIGH',     status: 'open', gemini_reasoning: 'Unattributed repost on a sports aggregation site.' },
  { violation_id: 'v4', asset_id: 'a3', detected_at: '2026-04-17T18:15:00Z', match_url: 'https://twitter.com/user/status/xyz',    match_type: 'visually_similar', gemini_class: 'NEEDS_REVIEW',      severity: 'MEDIUM',   status: 'open', gemini_reasoning: 'Visually similar but context is ambiguous.' },
];
...
const severityBars = [
  { label: 'Critical', count: 9,  pct: 75, color: 'bg-red-500' },
  { label: 'High',     count: 14, pct: 100, color: 'bg-orange-400' },
  { label: 'Medium',   count: 12, pct: 86, color: 'bg-amber-400' },
  { label: 'Low',      count: 7,  pct: 50, color: 'bg-zinc-400' },
];
...
const classConfig = {
  ...
  NEEDS_REVIEW:       { label: 'Review',       classes: 'text-blue-600 bg-blue-50' },
  ...
  return (
    <div className="space-y-16">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <StatCard label="Active Violations"  value="42"    icon={<AlertCircle className="w-5 h-5" />}   trend="+3"  trendUp={false} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="bento-card p-8 col-span-1 space-y-6">
          <div className="flex items-center justify-between">
            <h3 className="font-display font-black uppercase text-sm tracking-tight">By Severity</h3>
            ...
            {topDomains.map(({ domain, count, pct }, i) => (
              <div key={domain} className="flex items-center gap-4">
                ...
                <div className="flex-1 space-y-1">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-brand-text">{domain}</span>
