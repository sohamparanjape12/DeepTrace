...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-brand-bg flex">
      {/* Left: Branding Panel */}
      <div className="hidden lg:flex lg:w-1/2 bg-brand-text flex-col justify-between p-16 relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <span className="font-display font-black text-lg text-white uppercase tracking-tight">DeepTrace</span>
        </div>

        <div className="relative z-10 space-y-8">
          <h1 className="text-6xl font-display font-black text-white uppercase leading-[0.9] tracking-tight">
            Trace the <br />
          ...
          <div className="flex items-center gap-3 pt-4">
            ...
            <p className="text-[10px] font-black uppercase tracking-widest text-white/40">All Systems Operational</p>
          </div>
        </div>
        ...
        <div className="w-full max-w-sm space-y-10">
          ...
          <div className="space-y-4">
            <button
              ...
              className="w-full flex items-center justify-center gap-4 px-6 py-4 rounded-xl border-2 border-brand-border bg-white hover:border-brand-text hover:shadow-soft-lg transition-all duration-300 group"
            >
              {/* Google SVG icon */}
